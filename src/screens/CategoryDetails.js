        ...
        const fetchTransactions = async () => {
            ...
            try {
                ...
                for (const dateString of testDates) {
                    ...
                    const incomeRef = doc(db, 'Users', 'dong', dateString, 'income');
                    console.log('Income document path:', incomeRef.path);
                    ...
                    const outcomeRef = doc(db, 'Users', 'dong', dateString, 'outcome');
                    console.log('Outcome document path:', outcomeRef.path);
